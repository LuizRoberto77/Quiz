...
public class Questao1 extends javax.swing.JFrame {
     ...
     */
    //Cria e inicia variáveis para armazenar a questão correta
    int correcao1 = 0;
    int correcao2 = 0;
    int correcao3 = 0;
    int correcao4 = 0;
    int correcao5 = 0;
    //Cria a varivel que vai receber o ponto da questao selecionada
    int ponto;
    //Cria um Array para armazenar a questao correta do banco
    int correcao[] = new int[5];
    public Questao1()  {        
        initComponents();
        usuario u = new usuario();
        //↓Coloca o nick do usuario na lblNick
        ...
        rdngrp1.add(rdbA4);
        rdngrp1.add(rdbA5);
        //↓Assim que abre a tela o RdbA1 já estara selecionado
        ...
        try{
            c.getConexao(); 
            //Array que armazena as alternativas
            String alternativa[] = new String[5];
            //consulta a descrição da questão 1
            st2 = (PreparedStatement) con.prepareStatement("SELECT descricao FROM `questoes` where idquestoes = 1;");
            rs2 = st2.executeQuery();
            if(rs2.next()){
                //Coloca a questão na lblDescricao
                lblDescricaoQ.setText(rs2.getString("descricao"));
            }      
                //Consulta os dados da Questão 1 aleatoriamente
                st = (PreparedStatement) con.prepareStatement("SELECT Qdescricao,correta FROM `alternativas` where idquestoes = 1 ORDER by rand();");
                rs = st.executeQuery();
                int i = 0;
                //preenche os arrays com dados do banco
                while(rs.next()){   
                alternativa[i] = (rs.getString("Qdescricao"));
                correcao[i] = (rs.getInt("correta")); 
                i += 1;
                }
                //↓Preenche os radio button com as questões e as variveis de correção com os dados do banco  
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(rdbA1, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(rdbA2, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(rdbA4, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(rdbA5, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(rdbA3, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnDesistirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDesistirActionPerformed
        ...
        com.mysql.jdbc.PreparedStatement st;
            ResultSet rs;
            //↓verifica qual tipo de usuario o jogador é e manda para sua respectiva tela principal
            //Alem de zerar os pontos
