...
public class Questao5 extends javax.swing.JFrame {
    ...
    public Questao5()  {        
        ...
        try{
            ...
            st2 = (PreparedStatement) con.prepareStatement("SELECT descricao FROM `questoes` where idquestoes = 5;");
            rs2 = st2.executeQuery();
            if(rs2.next()){
                lblDescricaoQ.setText(rs2.getString("descricao"));
            }          
                st = (PreparedStatement) con.prepareStatement("SELECT Qdescricao,correta FROM `alternativas` where idquestoes = 5 ORDER by rand();");
                rs = st.executeQuery();
                int i = 0;
                while(rs.next()){   
