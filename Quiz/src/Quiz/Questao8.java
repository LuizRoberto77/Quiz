...
public class Questao8 extends javax.swing.JFrame {
    ...
    public Questao8()  {        
        ...
        try{
            ...
            st2 = (PreparedStatement) con.prepareStatement("SELECT descricao FROM `questoes` where idquestoes = 8;");
            rs2 = st2.executeQuery();
            if(rs2.next()){
                lblDescricaoQ.setText(rs2.getString("descricao"));
            }          
                st = (PreparedStatement) con.prepareStatement("SELECT Qdescricao,correta FROM `alternativas` where idquestoes = 8 ORDER by rand();");
                rs = st.executeQuery();
                int i = 0;
                while(rs.next()){   
            ...
            c.FechaConexao();
                ...
                Logger.getLogger(Questao8.class.getName()).log(Level.SEVERE, null, ex);
        }           
    }
    ...
    private void btnProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProximoActionPerformed
        ...
        lblNick.setText(String.valueOf(ponto));
