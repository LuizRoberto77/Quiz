...
public class Questao6 extends javax.swing.JFrame {
    ...
    public Questao6()  {        
        ...
        try{
            ...
            st2 = (PreparedStatement) con.prepareStatement("SELECT descricao FROM `questoes` where idquestoes = 12;");
            rs2 = st2.executeQuery();
            if(rs2.next()){
                lblDescricaoQ.setText(rs2.getString("descricao"));
            }          
                st = (PreparedStatement) con.prepareStatement("SELECT Qdescricao,correta FROM `alternativas` where idquestoes = 12 ORDER by rand();");
                rs = st.executeQuery();
                int i = 0;
                while(rs.next()){   
            ...
            c.FechaConexao();
                ...
                Logger.getLogger(Questao6.class.getName()).log(Level.SEVERE, null, ex);
        }           
    }
