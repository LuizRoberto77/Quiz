...
public class Questao4 extends javax.swing.JFrame {
    ...
    public Questao4()  {        
        ...
        try{
            ...
            st2 = (PreparedStatement) con.prepareStatement("SELECT descricao FROM `questoes` where idquestoes = 4;");
            rs2 = st2.executeQuery();
            if(rs2.next()){
                lblDescricaoQ.setText(rs2.getString("descricao"));
            }          
                st = (PreparedStatement) con.prepareStatement("SELECT Qdescricao,correta FROM `alternativas` where idquestoes = 4 ORDER by rand();");
                rs = st.executeQuery();
                int i = 0;
                while(rs.next()){   
            ...
            c.FechaConexao();
                ...
                Logger.getLogger(Questao4.class.getName()).log(Level.SEVERE, null, ex);
        }           
    }
    ...
    private void initComponents() {
        ...
        btnDesistir2 = new javax.swing.JButton();
        ...
        btnDesistir2.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        btnDesistir2.setText("Desistir");
        btnDesistir2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDesistir2ActionPerformed(evt);
            }
        });
    ...
    private void btnDesistir2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDesistir2ActionPerformed
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_btnDesistir2ActionPerformed
    ...
    private javax.swing.JButton btnDesistir2;
