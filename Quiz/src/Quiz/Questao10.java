...
public class Questao10 extends javax.swing.JFrame {
     ...
     */
    //aqui tem coisa nova va ate o metodo do botão finalizar
    int correcao1 = 0;
    int correcao2 = 0;
    int correcao3 = 0;
    int correcao4 = 0;
    ...
    public Questao10()  {        
        ...
        try{
            ...
            st2 = (PreparedStatement) con.prepareStatement("SELECT descricao FROM `questoes` where idquestoes = 11;");
            rs2 = st2.executeQuery();
            if(rs2.next()){
                lblDescricaoQ.setText(rs2.getString("descricao"));
            }          
                st = (PreparedStatement) con.prepareStatement("SELECT Qdescricao,correta FROM `alternativas` where idquestoes = 11 ORDER by rand();");
                rs = st.executeQuery();
                int i = 0;
                while(rs.next()){   
    ...
    private void initComponents() {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            .addComponent(rdbA5, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel8)
                    .addComponent(lblDescricaoQ, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblNick))
    ...
    private void btnFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinalizarActionPerformed
        ...
        try {
            ...
            ResultSet rs;
            //↓Verifica se o usuario é jogador ou adm.
            st = (com.mysql.jdbc.PreparedStatement) con.prepareStatement("select tipo,idusuario from usuario where nickname='"+u.getNick()+"'");
            rs = st.executeQuery();
            while(rs.next()){
                //↓se Adm o Teste é concluído, a pontuação zera e volta pra tela principal de adm 
                if(rs.getString("tipo").equals("1")){
                    JOptionPane.showMessageDialog(null,"<html>Teste Concluido<br>Pontos registrados: "+Pontuacao.getPontos()+" Pontos<html>");
                    Pontuacao.zerapontos();
                    this.dispose();
                    new PrincipalA().setVisible(true);
                //↓Se Jogador inseri a pontuação no banco, zera os pontos e Abre a tela de ranking
                }else if(rs.getString("tipo").equals("2")){
                    
                    JOptionPane.showMessageDialog(null,"<html>Sua Pontuação foi de: "+Pontuacao.getPontos()+" Pontos<html>");
                     String sql = "";
                        sql += "INSERT INTO `pontuacao`(`idpontuacao`, `idusuario`, `pontos`, `data`)";
                        sql += " VALUES ";
                        sql += " (NULL,'"+rs.getInt("idusuario")+"', '"+Pontuacao.getPontos()+"',now());";
