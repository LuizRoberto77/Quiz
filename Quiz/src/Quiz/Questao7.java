...
public class Questao7 extends javax.swing.JFrame {
    ...
    public Questao7()  {        
        ...
        try{
            ...
            st2 = (PreparedStatement) con.prepareStatement("SELECT descricao FROM `questoes` where idquestoes = 7;");
            rs2 = st2.executeQuery();
            if(rs2.next()){
                lblDescricaoQ.setText(rs2.getString("descricao"));
            }          
                st = (PreparedStatement) con.prepareStatement("SELECT Qdescricao,correta FROM `alternativas` where idquestoes = 7 ORDER by rand();");
                rs = st.executeQuery();
                int i = 0;
                while(rs.next()){   
            ...
            c.FechaConexao();
                ...
                Logger.getLogger(Questao7.class.getName()).log(Level.SEVERE, null, ex);
        }           
    }
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblNick)
                    .addComponent(lblDescricaoQ, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE))
